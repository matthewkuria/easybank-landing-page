...
export default function Hero() {
    return (
        <section className="flex flex-col-reverse items-center md:flex-row max-w-full overflow-x-hidden mt-4">
            ...
            <div className="intro-image min-h-72">
                <img src={imageMockUps} alt="background image mobile" height={500} width={500} className=" absolute -top-0 right-0 md:-right-28 z-0" />
            </div>            
        </section>
    )
